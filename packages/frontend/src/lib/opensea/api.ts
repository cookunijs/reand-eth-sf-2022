...
import {
  ...
  getOrdersAPIPath,
  deserializeOrder,
} from 'opensea-js/lib/orders/utils';
import {
  Network,
  OpenSeaAPIConfig,
  OpenSeaAssetBundle,
...
import { assetBundleFromJSON, delay, tokenFromJSON } from 'opensea-js/lib/utils/utils';
import { assetFromJSON } from '@lib/opensea/utils';
import { OpenSeaAPIAssetModel, OpenSeaAssetQueryModel } from 'src/types/opensea';
...
export class OpenSeaAPI {
  ...
  public async getAsset(
    ...
    retries = 1
    // NOTE: Using extended OpenSeaAPIAssetModel
  ): Promise<OpenSeaAPIAssetModel> {
    let json;
    try {
    ...
    // NOTE: Using extended assetFromJSON
   ...
   */
  public async getAssets(query: OpenSeaAssetQueryModel = {}): Promise<{
    // NOTE: Using extended OpenSeaAPIAssetModel
    assets: OpenSeaAPIAssetModel[];
