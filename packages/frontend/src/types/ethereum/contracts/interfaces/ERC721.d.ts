...
interface ERC721Interface extends ethers.utils.Interface {
  functions: {
    '__ERC721_init(string,string)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: '__ERC721_init', values: [string, string]): string;
  ...
  decodeFunctionResult(functionFragment: '__ERC721_init', data: BytesLike): Result;
...
export class ERC721 extends BaseContract {
  ...
  callStatic: {
    __ERC721_init(name_: string, symbol_: string, overrides?: CallOverrides): Promise<void>;
