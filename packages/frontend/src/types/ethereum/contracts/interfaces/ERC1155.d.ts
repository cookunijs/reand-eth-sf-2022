...
interface ERC1155Interface extends ethers.utils.Interface {
  functions: {
    '__ERC1155_init(string)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: '__ERC1155_init', values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: '__ERC1155_init', data: BytesLike): Result;
...
export class ERC1155 extends BaseContract {
  ...
  callStatic: {
    __ERC1155_init(uri_: string, overrides?: CallOverrides): Promise<void>;
